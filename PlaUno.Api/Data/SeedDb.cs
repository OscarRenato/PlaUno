...
using PlaUno.Api.Data.Entities;
using System;
using System.Linq;
using System.Threading.Tasks;

namespace PlaUno.Api.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckUserAsync()
        {
            ...
            {
                _context.Users.Add(new User { Email = "oscarrenato@yahoo.com", FirstName = "Oscar", LastName = "Gomez", Password = "123456" });
                _context.Users.Add(new User { Email = "maria@yahoo.com", FirstName = "Maria", LastName = "Solano", Password = "123456" });
